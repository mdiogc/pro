...
class MediaFile(File):
    ...
    @property
    def info(self):
        return f"{self.path} [size={self.size}B], Codec: {self.codec}, Geolocalization: {self.geoloc}, Duration: {self.duration}s"
...
class VideoFile(MediaFile):
    ...
    @property
    def info(self):
        return f"{self.path} [size={self.size}B]Codec: {self.codec}\nGeolocalization: {self.geoloc}\nDuration: {self.duration}s\nDimensions: {self.dimensions}"
